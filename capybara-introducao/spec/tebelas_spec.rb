describe 'Tabelas', :tabs do
    ...
    it 'deve exibir o salario do stark' do
        #all pega todos os elementos
        atores = all('table tbody tr')
        #detect para percorer pela table
        #|ator| esta isolando 1 de cada vez
    ...
    it 'deve selecionar Chris Prat para remoção' do
        ...
        expect(msg).to eq 'Chris Pratt foi selecionado para remoção!'
    end
    ...
    it 'deve selecionar Chris Prat para edição' do
        ...
        msg = page.driver.browser.switch_to.alert.text
        expect(msg).to eq 'Chris Pratt foi selecionado para edição!'
    end
